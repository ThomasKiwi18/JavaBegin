    ...
    if (secondtime >= (time + 1)){ 
      ...
      if(seconden >= 200){ 
        ...
        if(seconden >= 500){ 
           ...
           textSize(40);
  fill(0,125,125); 
  text("Te laat, druk op stop opnieuw te proberen", 10,250,20); 
...
if(seconden < 200){ 
  ...
  textSize(40);
  fill(0,125,125); 
  text("Te vroeg, druk op stop om opnieuw te proberen", 10,250,20); 
} 
if(seconden > 200){ 
  if(seconden < 477){
  background (0,0,255);
  textSize(30);
  fill(0,125,125); 
  text("Goed gedaan, druk op stop om opnieuw te proberen", 10,250,20); 
